...
**Thirty-six rules** that catch the mistakes worth catching:

| | |
| --- | --- |
| `V001`–`V003` | the annotations themselves — typos, bad enum values, unknown prefixes |
| `V101`–`V127` | structure — a fact without a grain, a foreign key pointing at a fact, a dimension with no natural key |
