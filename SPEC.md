...
**3,306 lines of source**: 1,929 of code, 654 of docstrings, 170 of
comment, 553 blank. The prose share is deliberate and is house style —
...
Plus `profile/varda.yaml` — 12 annotations, 5 enums — and 157 tests in
2,389 lines.
